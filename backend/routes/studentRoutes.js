...
const { registerStudent,getProfile,getAllJobs,getMyJobs,uploadResume,updateProfile,applyJob } = require('../controllers/studentController.js');
...
router.post('/upload-resume',authMiddleware('student'),uploadResume);
